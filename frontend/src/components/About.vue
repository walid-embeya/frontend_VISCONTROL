...
<template>
  <Modelo titulo="Sobre la aplicación VISCONTROL">
    <div class="alert alert-light">
      ...
      <p class="text-center">por otro lada seguir los visitantes el día de la visita facilitando así el acceso a la
        información y mejorando la toma de decisión </p>
