...
import { faMessage, faUser, faMagnifyingGlass, faFilePen, faXmark, faIdCard, faSort, faUserPlus, faCheck, faHouse, faCircleMinus, faCircleLeft, faCircleInfo, faPlusCircle, faCircleCheck, faPenToSquare, faTrashCan, faSquareXmark, faFloppyDisk, faList } from '@fortawesome/free-solid-svg-icons'
import { faInstagram, faFacebook, faTwitter, faLinkedin } from '@fortawesome/free-brands-svg-icons'

// /* add icons to the library */
library.add(faMessage, faUser, faMagnifyingGlass, faFilePen, faXmark, faIdCard, faSort, faUserPlus, faCheck, faHouse, faCircleMinus, faCircleLeft, faInstagram, faLinkedin, faTwitter, faFacebook, faCircleInfo, faPlusCircle, faCircleCheck, faPenToSquare, faTrashCan, faSquareXmark, faFloppyDisk, faList)
