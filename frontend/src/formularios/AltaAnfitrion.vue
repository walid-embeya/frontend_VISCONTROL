...
export default {
  ...
  methods: {
    ...
    ...mapActions(personasStore, ['getAnfitrionesApi', 'getPersonaPorId' ]),
    ...
    crearAnfitrion() {
      ...
      // this.postPersona(this.personaParaAnadir).then((r) => this.invitadosApi.push(r.data))
    ...
    <Modelo titulo="CREACIÓN NUEVO ANFITRIÓN">
      ...
      <form class="p-2 border rounded" style="background-color: rgb(143, 170, 211);">
            ...
            <div class="container alert alert-dark border rounded mb-2">
                <div class="row mb-4">
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="nip" v-model="personaParaAnadir.nip" placeholder="NIP del anfitrión" required>
                  </div>

                  <div class="col-md-4">
                    <label for="area" class="form-label">Area</label>
                    <input type="text" class="form-control" id="area" v-model="personaParaAnadir.area" placeholder="area de encarga del anfitrión" required>
                  </div>

                  <div class="col-md-4">
                    <label for="role" class="form-label">Role</label>
                    <input type="text" class="form-control" id="role" v-model="personaParaAnadir.role" placeholder="role del anfitrión" required>
                  </div>
                </div>                        
            </div>
        ...
        <div class="d-flex justify-content-center p-2 mb-2">
            <button type="submit" class="btn btn-success d-inline me-1" @click.prevent="crearAnfitrion" data-bs-toggle="modal" data-bs-target="#confirmacionOperacion">
